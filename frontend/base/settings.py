...
SECRET_KEY = 't33-0mp95jsnnu)!641r!#1)jzw5w2j!#p^&@p-*o!_jkvfs7q'
...
WSGI_APPLICATION = 'frontend.base.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'frontend.base.pagination.MyPageNumberPagination',
    'PAGE_SIZE': 100,
